...
function RenderSubscriptionSuccess() {
  ...
  useEffect(() => {
    ga4Events.eventBusinessRenderMonthlyPurchase();
  }, []);
    ...
    <SoftBox pt={2} pb={3} px={3}>
      ...
      <SoftBox mb={1}>
        <SoftTypography color="text" fontWeight="regular" variant="body2">
          You just unlocked the fastest tool to create marketing ready renders for your clients! 😄
          <br />
          <br />
...
export default RenderSubscriptionSuccess;
